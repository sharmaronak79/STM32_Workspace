...
HAL_Delay(200);
strcpy(buf,"Application is Running\n\r");
HAL_UART_Transmit(&huart3, (uint8_t*)buf, strlen(buf), HAL_MAX_DELAY);
HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7, GPIO_PIN_SET);

sprintf(buf,"SYSCLOCK frequency : %ld\n\r",HAL_RCC_GetSysClockFreq());
HAL_UART_Transmit(&huart3, (uint8_t*)buf, strlen(buf), HAL_MAX_DELAY);

sprintf(buf,"HCLK frequency : %ld\n\r",HAL_RCC_GetHCLKFreq());
HAL_UART_Transmit(&huart3, (uint8_t*)buf, strlen(buf), HAL_MAX_DELAY);

sprintf(buf,"PCLOCK1 frequency : %ld\n\r",HAL_RCC_GetPCLK1Freq());
HAL_UART_Transmit(&huart3, (uint8_t*)buf, strlen(buf), HAL_MAX_DELAY);

sprintf(buf,"PCLOCK2 frequency : %ld\n\r",HAL_RCC_GetPCLK2Freq());
HAL_UART_Transmit(&huart3, (uint8_t*)buf, strlen(buf), HAL_MAX_DELAY);
